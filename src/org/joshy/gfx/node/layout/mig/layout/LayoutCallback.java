...
public abstract class LayoutCallback
{
	 ...
	 * @see UnitValue
	 * @see org.joshy.gfx.node.layout.mig.layout.ConstraintParser#parseUnitValue(String, boolean)
	 */
	 ...
	 * is returned nothing is done and this is the default.
	 * @see org.joshy.gfx.node.layout.mig.layout.BoundSize
	 * @see org.joshy.gfx.node.layout.mig.layout.ConstraintParser#parseBoundSize(String, boolean, boolean)
	 */
