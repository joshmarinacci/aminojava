...
public class x {
    ...
    public static List<Element> echildren(Element node) {
    ...
    // public static Document loadDocument(Reader reader) throws Exception {
    //     DocumentBuilder builder = DocumentBuilderFactory.newInstance().newDocumentBuilder();
    //     MyErrorHandler eh = new MyErrorHandler();
    //     builder.setErrorHandler(eh);
    ...
    public static void transform(Document doc, URL xsl, OutputStream out,
    ...
    public static void transform(Document doc, String xsl_filename, OutputStream out, String pname, String pvalue) throws Exception {
        transform(doc,new FileInputStream(xsl_filename),out,pname,pvalue);

    }

    public static void transform(Document doc, String xsl_filename, Writer out) throws Exception {
        transform(doc, new StreamSource(new FileInputStream(xsl_filename)), new StreamResult(out),null,null);
    }
    public static void transform(Document doc, String xsl_filename, OutputStream out) throws Exception {
    ...
    public static void p(Object obj) {
        if(obj instanceof Node) { p((Node)obj); return; }
        if(obj instanceof NodeList) { p((NodeList)obj); return; }
        if(obj instanceof Document) { p((Document)obj); return; }
    ...
    public static List<Element> xpathElements(Node node, String xpath) throws XPathExpressionException {
        XPath xp = XPathFactory.newInstance().newXPath();
